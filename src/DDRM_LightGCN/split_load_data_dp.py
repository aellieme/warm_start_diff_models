...
class GlobalTemporalSplitter:
    ...
    def split(self, train_p=0.7, val_p=0.1, test_p=0.2):
        """
        Разделение по квантилям временной метки.
        Возвращает словарь с массивами пар (uid, iid) для train/val/test.
        """
        n = len(self.df)
...
def initialize_data():
    ...
    data = splitter.split(train_p=0.7, val_p=0.1, test_p=0.2)
